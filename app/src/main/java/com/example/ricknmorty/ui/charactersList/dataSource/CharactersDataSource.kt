...
class CharactersDataSource(
    ...
    override fun loadInitial(
        ...
        coroutineScope.launch {
            val characterList =
                if (filterCharacter == null) repository.getCharacterByPage(page = 1) else repository.getCharacterFilter(
                    page = 1,
                    filterCharacter
                )
...
//        TODO("Not yet implemented")
    ...
    override fun loadAfter(params: LoadParams<Int>, callback: LoadCallback<Int, CharacterInfo>) {
        coroutineScope.launch {
            val characterList =
                if (filterCharacter == null) repository.getCharacterByPage(page = params.key) else repository.getCharacterFilter(
                    page = params.key,
                    filterCharacter
                )
