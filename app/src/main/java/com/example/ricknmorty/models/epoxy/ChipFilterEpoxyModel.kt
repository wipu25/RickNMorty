...
data class ChipFilterEpoxyModel(private val item: RickNMortyViewModel.ChipViewState,private val onItemSelected: (String) -> Unit): ViewBindingKotlinModel<ModelChipsFilterBinding>(
